...
public class ScoreTwoWithBalanceAuto3 extends SequentialCommandGroup{
    ...
    public ScoreTwoWithBalanceAuto3(IntakeSubsystem intake, ArmSubsystem arm, DrivetrainSubsystem drive){
        this.intake = intake;
        this.arm = arm;
        this.drive = drive;

        parkChargeStation = PathPlanner.loadPath("Balance on Charge Station 3", 1.00, 1.00);
        ...
        DriveIntakeCommand3 driveWithIntake = new DriveIntakeCommand3(intake, drive);
